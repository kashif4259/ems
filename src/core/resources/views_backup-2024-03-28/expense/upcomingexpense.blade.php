...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row" id="gettotal" data-url="{{ url('upcomingexpense/gettotal')}}">
                    ...
                    <div class="header">
                        <div class="d-flex justify-content-between flex-sm-row flex-column">
                            ...
                            <div class="d-flex flex-row">
                                <a href="#" class="btn btn-sm btn-fill btn-info" data-toggle="modal" data-target="#imports"><i class="ti-plus"></i> <?php echo trans('lang.add_new_expense');?></a>
                            </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="imports" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title"><?php echo trans('lang.add_new_upcoming_expense');?></h5>  
  ...
  <div class="row">   
    <div class="form-group col-lg-6" id="incomedate">
        <label for="date" class="control-label"> 
            <small class="req text-danger">* </small><?php echo 'Due Date';?></label>
        ...
        <div class="form-group col-lg-6">
          ...
          <select id="incomecategory" class="form-control" name="incomecategory" required data-url="{{ url('expensecategory/getdata')}}">
  ...
  <div class="row">
      <div class="form-group col-lg-6">
          ...
          <select id="incomesubcategory" class="form-control" required name="incomesubcategory" data-url="{{ url('expensecategory/subgetdatabycat')}}"></select>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
       <form action="#" id="dopay" autocomplete="off">
        <div class="modal-header">
          <h5 class="modal-title"><?php echo trans('lang.pay_bill');?></h5>  
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
          </button>
      </div>
        ...
        <div id="messagedopay" style="display:none;" class="alert alert-warning"><?php echo trans('lang.all_field_required');?></div>
         <div class="row">
           <div class="form-group col-lg-12">
              ...
              <select id="incomeaccount" class="form-control" name="incomeaccount" required data-url="{{ url('account/getdata')}}">
              ...
              <div class="modal-body">
               <div class="row">
								<div class="col-lg-12">
									<div class="form-group">
									  <label><small class="req text-danger">* </small><?php echo trans('lang.name');?></label>
									  <input type="text" class="form-control" name="editincomename" required id="editincomename" placeholder="<?php echo trans('lang.name');?>">
									 </div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="form-group col-lg-6" id="editincomedate">
									...
									<small class="req text-danger">* </small><?php echo 'Due Date';?></label>
									<div  class="input-group date" data-date-format="mm-dd-yyyy">
										<input id="editidate" class="form-control upcomingdate" name="editidate" required type="text" value="<?php echo date("Y-m-d");?>"/>
										<span class="input-group-addon" style="border: 1px solid #cecece;"><i class="fa fa-calendar"></i></span>
									</div>
								</div>
							...
							<div class="row">
								<div class="form-group col-lg-6">
                                  ...
                                  <label for="editincomecategory" class="error"></label>
								</div>
								<div class="form-group col-lg-6">
								  <label><small class="req text-danger">* </small><?php echo trans('lang.expense_sub_category');?></label>
								  <select id="editincomesubcategory" class="form-control" name="editincomesubcategory" required></select>
                                   <label for="editincomesubcategory" class="error"></label>
								</div>
							</div>
							<div class="row">
								<div class="form-group col-lg-12">
			...
			buttons: [
				{
					extend: 'copy',
					text:   'Copy',
					title: '<?php echo trans('lang.upcomingexpense');?>',
