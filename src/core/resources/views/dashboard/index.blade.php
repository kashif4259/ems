								...
								<table cellpadding="5" cellspacing="0" border="0" width="100%">
									<thead>
										<tr>
											...
											<th>
												<p class="mb-0 text-center">Total Income </p>
											</th>
											<th>
	...
	$.ajax({
        ...
        success: function(html) {
			...
			jQuery.each(objs, function (index, record) {
               		...
               		// let total = record.accountbalance;
					// record.accountbalance = (record.accountbalance - record.totalexpense);
					// record.accountbalance = (record.accountbalance + record.totalincome);
               		// console.log(total);
                 $("#userbalancedata").append(
	         		'<tr>'+
			 						...
			 						'</b></td>'+
									 '<td align="center"><b>'
			 							+currency+numberWithCommas(parseFloat(record.totalincome).toFixed(2))+
			 						'</b></td>'+
			 						'<td align="center"><b>'
			 							+currency+numberWithCommas(parseFloat(record.totalexpense).toFixed(2))+
			 						'</b></td>'+
									'<td align="center"><b>'
			 							+currency+numberWithCommas(parseFloat(record.remaining_balance).toFixed(2))+
			 						'</b></td>'+
			 					'</tr>'	);
        	 });
        }
