...
Route::group(['prefix' => 'internaltransfer'], function(){
    Route::get('/', 'TransferController@index');
    Route::get('/getdata', 'TransferController@getdata');
...
Route::get('/reports/userbalance', 'ReportsController@userbalance');
Route::get('/reports/getuserbalancereportdata', 'ReportsController@getuserbalancereportdata');

Route::get('/reports/categories', 'ReportsController@categoriesreport');
Route::get('/reports/getcategorydata', 'ReportsController@getcategoriesreportdata');

Route::get('/reports/general', 'ReportsController@generalReport');
Route::get('/reports/getdataforgeneralreport', 'ReportsController@getDataForGeneralReport');
...
Route::get('/home/userbalancereport','HomeController@userbalancereport');
Route::resource('home','HomeController');


Route::get('/home', 'HomeController@index')->name('home');

// Route::get('/test', 'TestController@sendTextMessage');